 ...
 void StereoCalib(vector<string>& imagelist, cv::Size boardSize, float squareSize, bool displayCorners , bool useCalibrated, bool showRectified)
{
    ...
    for( i = j = 0; i < nimages; i++ )
    {
        for( k = 0; k < 2; k++ )
        {
            ...
            found = findCirclesGrid(img, boardSize, corners);
            if( displayCorners )
            {
                cout << filename << endl;
                Mat cimg, cimg1;
                cvtColor(img, cimg, COLOR_GRAY2BGR);
                drawChessboardCorners(cimg, boardSize, Mat(corners), found);
...
// epipolar geometry constraint: m2^t*F*m1=0
    ...
    stereoRectify(cameraMatrix[0], distCoeffs[0],
                  ...
                  CALIB_ZERO_DISPARITY, 1, imageSize, &validRoi[0], &validRoi[1]);//CALIB_ZERO_DISPARITY
